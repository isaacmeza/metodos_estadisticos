...
merge m:1 junta exp anio using "$directorio\DB\seguimiento_m5m.dta", nogen
...
********************************************************************************
	...
	*************************
	esttab using "$directorio/Tables/reg_results/treatment_effects.csv", se star(* 0.1 ** 0.05 *** 0.01) b(a2) ///
