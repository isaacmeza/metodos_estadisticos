...
*********************************HD DATA****************************************
use  "$directorio\DB\scaleup_hd.dta", clear
...
*Equivalently the first value of alpha (in increasing order) such 
*that the constraint is achieved by equality (as the constraint is a
*monotone increasing function in alpha)
...
graph export "$directorio/Figuras/ps_overlap.pdf", replace 
...
qui putexcel I5=matrix(r(matrix)) using "$directorio\Tables\assess_unconfoundedness.xlsx", sheet("balance_match") modify
...
*Baseline
	...
	qui putexcel B27=("`r(mean)'")  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify
*ATE
	mat def ate=e(b)
	local ate=round(ate[1,1],0.1)
	qui putexcel `Col'29=("`ate'")  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify	
*Std Dev
	mat def var=e(V)
	local std=round(sqrt(var[1,1]),0.1)
	local sd="(`std')"
	qui putexcel `Col'32=("`sd'")  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify	
*Obs
	qui putexcel `Col'33=(e(n1))  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify
	qui putexcel `Col'34=(e(n0))  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify		
*Matches
	local mtch="[`e(k_nnmin)', `e(k_nnmax)']"
	qui putexcel `Col'35=("`mtch'")  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify
...
*Baseline
	...
	qui putexcel C27=("`r(mean)'")  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify
*ATE
	mat def ate=e(b)
	local ate=round(ate[1,1],0.1)
...
*Baseline
	...
	qui putexcel D27=("`r(mean)'")  using "$directorio/Tables/assess_unconfoundedness.xlsx", ///
		sheet("unconfoundedness_match") modify  
*ATE
	mat def ate=e(b)
	local ate=round(ate[1,1],0.1)
...
*Baseline
	...
	qui putexcel B27=("`r(mean)'")  using "$directorio/Tables/NN_match.xlsx", ///
		sheet("NN_match") modify
*ATE
	mat def ate=e(b)
	local ate=round(ate[1,1])
	qui putexcel `Col'29=("`ate'")  using "$directorio/Tables/NN_match.xlsx", ///
		sheet("NN_match") modify	
*Std Dev
	mat def var=e(V)
	local std=round(sqrt(var[1,1]))
	local sd="(`std')"
	qui putexcel `Col'32=("`sd'")  using "$directorio/Tables/NN_match.xlsx", ///
		sheet("NN_match") modify	
*Obs
	qui putexcel `Col'33=(e(n1))  using "$directorio/Tables/NN_match.xlsx", ///
		sheet("NN_match") modify
	qui putexcel `Col'34=(e(n0))  using "$directorio/Tables/NN_match.xlsx", ///
		sheet("NN_match") modify		
*Matches
	local mtch="[`e(k_nnmin)', `e(k_nnmax)']"
	qui putexcel `Col'35=("`mtch'")  using "$directorio/Tables/NN_match.xlsx", ///
		sheet("NN_match") modify
